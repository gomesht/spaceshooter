...
const aliensImg = ['img/inimigo1.png', 'img/inimigo2.png', 'img/inimigo3.png'];
...
function createAliens() {
    ...
    newAlien.style.left = '310px';
    newAlien.style.top = `${Math.floor(Math.random() * 310) + 30}px`;
...
function checkLaserCollision(laser, alien) {
    ...
    let alienBottom = alienTop - 90;
    if(laserLeft != 310 && laserLeft + 50 >= alienLeft) {
